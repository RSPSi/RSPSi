...
import com.rspsi.jagex.util.MapObjectData;
			...
			for (int x = 0; x < 64; x++) {
				for (int y = 0; y < 64; y++) {
					...
					for (MapObjectData object : tileObjs) {
						...
						val defaultWorldObject = new GameObject(new ObjectKey(object.getX(), object.getY(), object.getZ(), object.getId(), object.getType(), object.getOrientation(), false, false, false), object.getPosition(), new Vector3f(), new Quat4f());
