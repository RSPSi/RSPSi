...
public class DraggableNature implements EventHandler<MouseEvent> {
    ...
    private final List<Draggable.Listener> dragListeners = new ArrayList<>();
    @Setter @Getter
    ...
    public final boolean addListener(final Draggable.Listener listener) {
    ...
    public final void handle(final MouseEvent event) {
        if (MouseEvent.MOUSE_PRESSED == event.getEventType()) {
            ...
            if (!this.dragging) {
                this.dragging = true;
                for (final Draggable.Listener listener : this.dragListeners) {
    ...
    public final boolean removeListener(final Draggable.Listener listener) {
