...
import com.rspsi.editor.game.save.JagexLandscapeEncoder;
import com.rspsi.editor.game.save.JagexObjectEncoder;
...
public class MultiMapEncoder {
	...
	public static List<Chunk> decode(byte[] encoded){
		...
		for(int i = 0;i<size;i++) {
			...
			int cX = (64 * positionX) / 64;
			int cY = (64 * positionY) / 64;
