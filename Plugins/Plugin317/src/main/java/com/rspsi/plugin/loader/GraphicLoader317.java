...
public class GraphicLoader317 extends GraphicLoader {
	...
	public Graphic decode(Buffer buffer) {
		...
		int[] modifiedColours = new int[10];
		do {
			...
			if (opcode == 1) {
				...
				modifiedColours[opcode - 50] = buffer.readUShort();
				graphic.setReplacementColours(modifiedColours);
			} else {
