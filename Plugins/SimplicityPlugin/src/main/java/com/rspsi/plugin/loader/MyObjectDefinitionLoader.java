...
public class MyObjectDefinitionLoader extends ObjectDefinitionLoader {
	...
	private Buffer data;
	private Buffer buffer667;
	
	private int[] indices;
	private int[] indices667;
	...
	public void init(Archive config, Archive sound) throws IOException {
		...
		Buffer streamIdx667;
		try {
			buffer667 = new Buffer(sound.file("loc2.dat").getData());
			streamIdx667 = new Buffer(sound.file("loc2.idx").getData());
		} catch (Exception ex){
			buffer667 = new Buffer(config.file("loc2.dat").getData());
			streamIdx667 = new Buffer(config.file("loc2.idx").getData());
		}
		try {
	...
	public ObjectDefinition forId(int id) {
		...
		boolean loadNew = (
				...
				|| id == 36692 || id == 34138 || id >= 39260 && id <= 39271 || id == 39229 || id == 39230 || id == 39231
				|| id == 36676 || id == 36692 || id > 11915 && id <= 11929 || id >= 11426 && id <= 11444
